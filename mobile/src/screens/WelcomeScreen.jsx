...
const FEATURES = [
  ...
  {
    icon: MessageCircle,
    title: 'Обсуждение внутри задач',
    desc: 'Все договоренности, вопросы и уточнения остаются прямо рядом с задачей.',
  },
]
      ...
      >
        <View style={styles.heroCard}>
          ...
          <Text style={styles.heroText}>
            Приложение для семьи, где родители распределяют задачи, дети получают баллы и
            награды, а все обсуждение остается внутри нужных дел.
          </Text>
        ...
        <View style={[styles.sectionCard, shadows.card]}>
          ...
          <Text style={styles.audienceText}>Семей с детьми, где важно не просто вести список дел, а строить понятную систему: кто назначает, кто делает и за что получает награду.</Text>
        </View>
